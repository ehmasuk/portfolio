...
export function ThemeToggler() {
  ...
  if (!mounted) return <div className="size-4"></div>;
  ...
  return (
    <motion.svg
      ...
      className={cn(isDark ? "size-5" : "size-4", "text-black dark:text-white hover:text-foreground duration-500 cursor-pointer")}
      viewBox="0 0 24 24"
    >
      <motion.g
        fill="none"
